...
public class Utils {
    ...
    public static String getRootDomainUrl (String url) {
    ...
    public static void bookmarkUrl(Context context, String url) {
        SharedPreferences pref = context.getSharedPreferences("androidBrowser", 0); // 0 - for private mode
    ...
    public static boolean isBookmarked(Context context, String url) {
        SharedPreferences pref = context.getSharedPreferences("androidBrowser", 0);
